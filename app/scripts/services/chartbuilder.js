  ...
  .factory('chartBuilder',['$rootScope', function ($rootScope) {
    ...
    charts.buildZoneChart = function(graphData, zones){
      ...
      var chartConfig = {
        ...
        //Series object (optional) - a list of series using normal highcharts series options.
        series: [],//will set data later
        //Title configuration (optional)
        title: {
          text: 'Number of Devices per Zone '
        },
        //Boolean to control showng loading status on chart (optional)
        //Could be a string if you want to show specific loading text.
        loading: 'Retrieving Data From Server...',
        //Configuration for the xAxis (optional). Currently only one x axis can be dynamically controlled.
        //properties currentMin and currentMax provied 2-way binding to the chart's maximimum and minimum
        xAxis: {
          categories: [], //will set in controller
          title: {text: 'Zone'},
          labels: {
            step: 1,
            maxStaggerLines: 2
        ...
        yAxis: {
         title: {text: 'Number of Devices per Zone'},
         floor: 0
        },
        //Whether to use HighStocks instead of HighCharts (optional). Defaults to false.
        useHighStocks: false,
      ...
      this.builtCharts.zoneChart = chartInfo;
      return chartInfo;
    };
